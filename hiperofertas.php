								...
								<ul>
									<li>
										...
										if(isset($_GET['pag'])){
											...
											<span>(
												<?php
												$estrellas5 = mysqli_query($mysqli,"SELECT COUNT(*) AS estrellas5 FROM productos WHERE estrellas='5' and descuento>'0.00' ");
									...
									<li>
										...
										if(isset($_GET['pag'])){
											...
											<span>(
												<?php
												$estrellas4 = mysqli_query($mysqli,"SELECT COUNT(*) AS estrellas4 FROM productos WHERE estrellas='4' and descuento>'0.00' ");
									...
									<li>
										...
										if(isset($_GET['pag'])){
											...
											<span>(
												<?php
												$estrellas3 = mysqli_query($mysqli,"SELECT COUNT(*) AS estrellas3 FROM productos WHERE estrellas='3' and descuento>'0.00' ");
									...
									<li>
										...
										if(isset($_GET['pag'])){
											...
											<span>(
												<?php
												$estrellas2 = mysqli_query($mysqli,"SELECT COUNT(*) AS estrellas2 FROM productos WHERE estrellas='2' and descuento>'0.00' ");
									...
									<li>
										...
										if(isset($_GET['pag'])){
											...
											<span>(
												<?php
												$estrellas1 = mysqli_query($mysqli,"SELECT COUNT(*) AS estrellas1 FROM productos WHERE estrellas='1' and descuento>'0.00' ");
									...
									<li>
										...
										if(isset($_GET['pag'])){
											...
											<i class="fa fa-caret-right"></i> Nuevo <span>(
												<?php
												$condicion2 = mysqli_query($mysqli,"SELECT COUNT(*) AS condicion_nuevo FROM productos WHERE condicion='Nuevo' and descuento>'0.00' ");
									...
									<li>
										...
										if(isset($_GET['pag'])){
											...
											<i class="fa fa-caret-right"></i> Usado <span>(
												<?php
												$condicion1 = mysqli_query($mysqli,"SELECT COUNT(*) AS condicion_usado FROM productos WHERE condicion='Usado' and descuento>'0.00'");
				...
				<div class="col-lg-9 col-md-8">
					<div class="categorie_d_right">
						<div class="categorie_product_toolbar mb-30">
							...
							$productos = mysqli_query($mysqli,"SELECT COUNT(*) AS productos FROM productos WHERE estado = '0' and descuento>'0.00' and descripcion LIKE '%$n%'");
						...
						<div class="tab-content" id="myTabContent">
							<div class="tab-pane fade show active" id="large" role="tabpanel">
								<div class="row cate_tab_product">
									...
									$productos = "SELECT * FROM productos WHERE estado = '0' and descuento>'0.00' and descripcion LIKE '%$n%' and ".$filtro." ORDER BY id_producto DESC LIMIT $inicial,$limite";
