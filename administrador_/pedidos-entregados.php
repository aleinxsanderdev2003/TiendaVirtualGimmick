								...
								<div class="table-responsive">
									<table class="table table-bordered table-hover">
										...
										<tbody>
											...
											$pedidos="SELECT * FROM pedido WHERE fecha LIKE '%$q%' and estado='2' LIMIT $inicial,$limite";
											...
											while ($pedido=mysqli_fetch_row ($pedidos_)){
												...
												<td><a href="factura?id='.htmlentities($id_pedido).'#tienda"><button class="btn btn-danger" style="background-color: #DE674D;">FACTURA</button></a></td>
												</tr>
