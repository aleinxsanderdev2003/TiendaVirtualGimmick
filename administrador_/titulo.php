...
<body class="hold-transition sidebar-mini">
							...
							<div class="panel-body">
								...
								<div class="table-responsive">
									<table class="table table-bordered table-hover">
										<thead>
											<tr>
												<th class="all">TITULO DEL SISTEMA </th>
										...
										<tbody>
											...
											$configuracion="SELECT id_config, titulo FROM configuracion";
											...
											while ($config=mysqli_fetch_row ($configuracion_)){
												...
												'
												<tr>
												<td><input type="text" id="titulo" class="form-control" value="'.htmlentities($titulo).'"></td>
												<td>
												<button type="button" id="titulo-editar"><img src="../img_/editar.png" width="50"></button>
												</td>
												</tr>
												';
	...
	<script src="validaciones_/_configuracion/js/titulo-editar.js"></script>
