		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<div class="header-title">  
					<h1>BOLETINES</h1>
					<small>Lista de boletines</small>
							...
							<div class="panel-body">
									...
									<div class="panel-header">
										...
										<div class="col-sm-6 col-xs-12">
											<div class="dataTables_length">
												<label>Boletines registradas en el sistema <?php include'include_/nombre.php' ?></label>
											</div>
										</div>
											...
											<div class="dataTables_length">
												<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
													<div class="input-group custom-search-form">
														<input type="search" class="form-control" id="buscando" name="buscando" placeholder="Busca boletin por correo..">
								...
								<div class="table-responsive">
									<table class="table table-bordered table-hover">
										<thead>
											<tr>
												<th class="all">ID</th>
												<th class="min-perfil">CORREO</th>
												<th class="min-ip">DESCRIPCIÓN</th>
												<th class="min-ip">FECHA REGISTRO</th>
												<th class="min-ip">OPCIONES</th>
											</tr>
										</thead>
										<tbody>
											...
											$boletines="SELECT * FROM boletines WHERE correo LIKE '%$q%' ORDER BY fecha_registro ASC LIMIT $inicial,$limite";
											$boletines_=mysqli_query($mysqli,$boletines);

											while ($bole=mysqli_fetch_row ($boletines_)){

												$id_boletin=$bole[0];
												$correo=$bole[1]; 
												$descripcion=$bole[2];
												$fecha_registro=$bole[3]; 
												...
												<td><a href="correo?correo='.$correo.'&nombre="><button class="btn" style="background-color: #036B77; border: none; color: white;">ENVIAR CORREO</button></a></td>
												</tr>
												';
								...
								<div class="page-nation text-right">
									<ul class="pagination pagination-large">
										<?php 
										$ressql=mysqli_query($mysqli,$boletines);
