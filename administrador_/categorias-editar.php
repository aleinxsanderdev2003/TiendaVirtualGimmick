...
<body class="hold-transition sidebar-mini">        
    ...
    $categorias="SELECT * FROM categorias WHERE id_categoria='$id_categoria'";
                        ...
                        <div class="panel-body">
                         ...
                         <div class="card shadow-sm border-0 mb-4">
                                        ...
                                        <div class="row ">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group ">
                                                    <input type="text" class="form-control" id="id_categoria" name="id_categoria" value="<?php echo $id_categoria ?>" style="display: none;">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row ">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group ">
                                                    <label>Nombre</label>
                                                    <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $nombre; ?>" placeholder="Ingresa el nombre">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer">
                                ...
                                <button type="button" id="categorias-editar" class="btn btn-primary float-right">Editar</button>
                            </div>
                        </div>
...
<script type="text/javascript" src="validaciones_/_categorias/js/categorias-editar.js"></script>
