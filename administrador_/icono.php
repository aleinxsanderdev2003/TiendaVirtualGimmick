...
if(isset($_GET['edit_true'])){
	...
	$query = "UPDATE configuracion SET favicon='$fotoproducto1' WHERE id_config='$edit_true'";
	...
	if($resul){
		...
		if($query){
			...
			echo "<script>location.href='icono'</script>";
						...
						<div class="panel panel-bd lobidrag">
							<div class="panel-body">
								...
								<div class="table-responsive">
									...
									$sql=("SELECT id_config , favicon FROM configuracion ");
									...
									while($arreglo=mysqli_fetch_array($query)){
										...
										if(isset($_GET['edit'])){
											echo "<form action='icono?edit_true=".$arreglo[0]."' method='post' enctype='multipart/form-data'>";
											echo '<td>
											...
											echo "<td><center><img src='../img_/$arreglo[1]' width='80'></center></td>";
										...
										if(isset($_GET['edit'])){
											...
											echo "<td><center><button type='submit' class='btn'><img src='../img_/editar2.png' width='60'></button><br><br><br><a href='icono'>VOLVER</a></center></td>";
											...
											echo "<td><center><a href='icono?edit=true'><img src='../img_/editar.png' width='60'></a></center></td>";
